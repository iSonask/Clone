...
//How to Use:
extension ViewController: SBMessageInputViewDelegate{
    ...
    func inputViewDidTapButton(button: UIButton) {
        let mystring = msgView.textView.text.trimmingCharacters(in: .whitespacesAndNewlines)
        print(mystring.trimmingCharacters(in: .illegalCharacters)) 
    }
